...
def main():
    ...
    parser.add_argument('--lambda_atom_type', type=float, default=0.5)
    parser.add_argument('--lambda_bond', type=float, default=0.1)
    ...
    parser.add_argument('--debug_atom_type', action='store_true', default=False)
