...
def main():
    ...
    parser.add_argument('--use_s_gate', action='store_true', default=True)
    parser.add_argument('--feat_use_s_gate', action='store_true', default=True)
    ...
    parser.add_argument('--graph_use_all_t', action='store_true', default=False)
